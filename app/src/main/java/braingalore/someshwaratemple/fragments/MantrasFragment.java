...
import braingalore.someshwaratemple.adapters.MantrasExpandableListAdapter;
...
public class MantrasFragment extends Fragment {
    ...
    MantrasExpandableListAdapter listAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup vg,
        ...
        // preparing list data
        prepareListData();
        listAdapter = new MantrasExpandableListAdapter(getActivity(), listDataHeader, listDataChild);
